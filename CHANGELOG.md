...
- Complete functionality of window colors library

### Improvements

- Better UI and cards design
...
- Better predefined colors
- Predefined gradients
- New icons
- Now dashboard supports Workspace color, which can be defined in .vscode/settings.json

### Refactor

- User prettier to prettify all .js and .ts files
